 ...
 * @Layouts[head=DocsQuickStartHeader,foot=DocsFooter]
 */

class QuickStartController extends Acontroller
{
    /**
     * QuickStartController constructor.
     * @param Aorm $model
     */
    ...
    /**
     * @Routing[value=quick-start,type=html]
    */
